...
import DeckListPopoverComponent from "./DeckListPopoverComponent";
...
const DraftComponent: React.SFC<DraftProps> = props => {
  ...
  const deckListPopover = (
    <Popover id="popover-trigger-click-root-close" title="カード種別に表示" style={{maxWidth: 1000}}>
      <DeckListPopoverComponent draftDeckList={props.me.draftDeckList}/>
    </Popover>
  );
